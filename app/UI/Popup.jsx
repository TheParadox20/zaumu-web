...
export default function Popup(){
    ...
    return(
        <div className={`fixed bg-white top-8 right-0 px-4 pt-4 w-96 rounded-md z-50 shadow-lg transition-transform duration-500 ease-in-out transform shadow-primary-light ${hidden ? 'translate-x-full shadow-none' : 'translate-x-0 md:mr-4'}`} onClick={e=>setHidden(true)}>
